...
<title>Editorial Register - To-Do</title>
...
<div class="magazine-container">
  ...
  <header class="magazine-header">
    <div class="sub-title">New Entry</div>
    <h1>할일 등록</h1>
  </header>

  <!-- Form -->
  <form action="${pageContext.request.contextPath}/todo/register" method="post" class="register-form">
    
    <!-- Title -->
    <div class="form-group">
      <label for="title">Title</label>
      <input type="text" name="title" id="title" class="form-control" placeholder="등록할 할 일을 입력해 주세요" required>
    </div>
    ...
    <div class="btn-group">
      ...
      <a href="${pageContext.request.contextPath}/todo/list" class="btn btn-cancel">취소</a>
    </div>
